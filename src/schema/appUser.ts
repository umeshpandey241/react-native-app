...
export const appUser = (t: TransFn) => ({
  ...
  firstName: stringOnlyAlphabets(
    t('appUsers.columns.fields.firstName'),
    t,
    2,
    100,
  ),
  lastName: stringOnlyAlphabets(
  ...
  district: stringAlphanumeric(
    t('appUsers.columns.fields.district'),
    t,
    1,
    100,
  ),
  address: stringAlphanumericWithSpecialChars(
    t('appUsers.columns.fields.address'),
    t,
    2,
    10000,
  ),
  addressLine: stringAlphanumericWithSpecialChars(
    t('appUsers.columns.fields.addressLine'),
    t,
    2,
    10000,
  ),
  defaultLanguage: stringOnlyAlphabets(
    t('appUsers.columns.fields.defaultLanguage'),
    t,
    2,
    10,
  ),
  verifyShop: requiredStringField(
  ...
  gstCertificate: fileUploadField(
    t('appUsers.columns.fields.gstCertificate'),
    t,
    1,
    2,
  ),
  photoShopFront: fileUploadField(
    t('appUsers.columns.fields.photoShopFront'),
    t,
    1,
    2,
  ),
  visitingCard: fileUploadField(
  ...
  photoAttachment: fileUploadField(
  ...
  // reportedTo: requiredMultiSelectField(
  //   t('appUsers.columns.fields.reportedTo'),
  //   t,
  //   1,
  //   100,
  // ),
  reportedBy: requiredStringField(
  ...
  totalPlot: stringNumeric(t('appUsers.columns.fields.totalPlot'), t, 0, 100),
