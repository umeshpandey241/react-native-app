...
const getAll = async (token?: string | unknown, language?: string) => {
  ...
  try {
    ...
    const response = await fetch(`${BASE_URL}/Leadership/Get`, {
      method: 'POST',
      // headers,
...
const getById = async (
  ...
  try {
    ...
    const response = await fetch(`${BASE_URL}/Leadership/GetById`, {
      method: 'POST',
      headers,
      body: JSON.stringify(payload),
    });
...
const draft = async (
  ...
  try {
    ...
    const response = await fetch(`${BASE_URL}/Leadership/Draft`, {
      method: 'POST',
      headers,
      body: JSON.stringify(payload),
    });
...
const update = async (
  ...
  try {
    ...
    const response = await fetch(`${BASE_URL}/Leadership/Update`, {
      method: 'POST',
      headers,
      body: JSON.stringify(payload),
    });
...
const deleteData = async (
  ...
  try {
    ...
    const response = await fetch(`${BASE_URL}/Leadership/Delete`, {
      method: 'POST',
      headers,
      body: JSON.stringify(payload),
    });
...
const fileUpload = async (
  ...
  try {
    ...
    const response = await fetch(`${BASE_URL}/Leadership/FileUpload`, {
      method: 'POST',
      // headers: {
...
const fileDownload = async (
  ...
  try {
    ...
    const response = await fetch(`${BASE_URL}/Leadership/Download`, {
      method: 'POST',
      headers,
...
const getHomeCommonData = async (
  ...
  try {
    ...
    const response = await fetch(`${BASE_URL}/Leadership/GetHomeCommonData`, {
      method: 'POST',
      headers,
      body: JSON.stringify(payload),
    });
...
const getHtmlData = async (token?: string | unknown, language?: string) => {
  ...
  try {
    ...
    const response = await fetch(`${BASE_URL}/Leadership/GetHtmlData`, {
      method: 'POST',
      headers,
      body: JSON.stringify(payload),
    });
...
const getHomeUserData = async (token?: string | unknown, language?: string) => {
  ...
  try {
    ...
    const response = await fetch(`${BASE_URL}/Leadership/GetHomeUserData`, {
      method: 'POST',
      headers,
      body: JSON.stringify(payload),
    });
...
const deleteUser = async (token?: string | unknown, language?: string) => {
  ...
  try {
    ...
    const response = await fetch(`${BASE_URL}/Leadership/DeleteUser`, {
      method: 'POST',
      headers,
      body: JSON.stringify(payload),
    });
