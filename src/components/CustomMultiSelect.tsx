...
import { MaterialCommunityIcons, Text, View, TouchableOpacity, Pressable, TextInput, FlatList, useTranslation } from '../sharedBase/globalImport';
...
const CustomMultiSelect = ({
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.chipsContainer}>
                {selectedValues.map((value) => (
                    <View key={value.toString()} style={styles.chip}>
                        ...
                        <Pressable onPress={() => onValueChange(selectedValues.filter((v) => v !== value))}>
            ...
            >
                <View style={[styles.modalContent, { borderTopLeftRadius: 16, borderTopRightRadius: 16, maxHeight: '80%' }]}>
                    ...
                    <View style={styles.buttonContainer}>
                        ...
                        <TouchableOpacity style={[styles.button, styles.okButton]} onPress={applySelection}>
